function RebootModule(ip,DefaultTimeout)
...
% This function reboots the module using the REST PUT command
% /rest/rec/reboot

webwrite(strcat(strcat("http://",ip),"/rest/rec/reboot"),weboptions('RequestMethod','put','Timeout',DefaultTimeout));
