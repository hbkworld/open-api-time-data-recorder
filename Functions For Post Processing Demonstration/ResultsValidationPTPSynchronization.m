function ResultsValidationPTPSynchronization(ResultsFilename)
...
Module2ReceiverGeneratorOutput1 = RecordingData.SignalData{5,1};
...
figure(9)
plot(Module1ReceiverGeneratorOutput1,'x')
hold on
plot(Module2ReceiverGeneratorOutput1,'ro')
xlabel('Sample Number')
ylabel('Voltage')
title('PTP Synchronization Check (Generator 1 Signal)')
legend('Module 1','Module 2')
xlim([0 length(Module1ReceiverGeneratorOutput1)])
ylim(VoltageGraphLimits)
