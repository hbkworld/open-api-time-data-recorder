function WaitForInputState(ip,DefaultTimeout,TargetInputStatus)
...
% /rest/rec/onchange returns a inputStatus of TargetInputStatus
...
while RecorderStatus.inputStatus ~= TargetInputStatus
