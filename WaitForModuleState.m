function WaitForModuleState(ip,DefaultTimeout,TargetModuleState)
...
% /rest/rec/onchange returns a moduleState of TargetModuleState
...
while RecorderStatus.moduleState ~= TargetModuleState
